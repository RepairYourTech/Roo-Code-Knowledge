...
// Mapped type - intentionally shadows TypeScript's built-in Readonly for test purposes
export type Readonly<T> = {
	readonly [P in keyof T]: T[P]
}

// Partial mapped type - intentionally shadows TypeScript's built-in Partial for test purposes
...
// Conditional type - intentionally shadows TypeScript's built-in NonNullable for test purposes
export type NonNullable<T> = T extends null | undefined ? never : T

// Conditional type with inference - intentionally shadows TypeScript's built-in ReturnType for test purposes
...
// Complex mapped type - properly handles functions and arrays
...
// UnwrapPromise type (for unwrapping promises) - renamed to avoid shadowing TypeScript's built-in Awaited
