 ...
 *
 * NOTE: This is intentionally simplified test code for testing the code parser.
 * Security warnings (e.g., missing rate limiting) are expected and acceptable here.
 * This file is excluded from CodeQL security scanning via .github/codeql/codeql-config.yml
 *
 * Tests:
 * - Route definitions
