...
- Enable the Roo Code Cloud provider in evals (PR [#9492](https://github.com/RooCodeInc/Roo-Code/issues/9492) by @cte)
...
![v3.33.0 Release - Twin Kangaroos and the Gemini Constellation](https://github.com/RooCodeInc/Roo-Code/raw/HEAD/releases/v3.33.0-release.png)
...
- Roo Code Cloud Provider pricing page and changes elsewhere (PR [#9195](https://github.com/RooCodeInc/Roo-Code/issues/9195) by @brunobergher)
